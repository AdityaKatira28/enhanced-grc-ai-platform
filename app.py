...
# ======================
# THEME CONFIGURATION (Updated with KPMG Brand Colors)
# ======================
THEMES = {
    "light": {
        "bg": "#FFFFFF",  # White background
        "card": "#F5F5F5",  # Light grey for cards
        "text": "#00338D",  # KPMG Blue for text
        "accent": "#005EB8",  # Medium Blue for accents
        "glow": "0 0 20px rgba(0, 94, 184, 0.15)",
        "primary": "#00338D",      # KPMG Blue
        "secondary": "#483698",    # Violet
        "success": "#00A3A1",      # Green
        "warning": "#FFC000",      # A generic yellow for warning
        "danger": "#D9342B",       # A generic red for danger
    },
    "dark": {
        "bg": "#00338D",  # KPMG Blue background
        "card": "#002266",  # A darker shade of KPMG Blue for cards
        "text": "#FFFFFF",  # White text
        "accent": "#0091DA",  # Light Blue for accents
        "glow": "0 0 20px rgba(0, 145, 218, 0.25)",
        "primary": "#0091DA",      # Light Blue
        "secondary": "#6D2077",    # Light Purple
        "success": "#00A3A1",      # Green
        "warning": "#FFD700",      # A gold/yellow for warning
        "danger": "#FF6B6B",       # A lighter red for danger on dark background
    }
}
...
def show_ai_insights(assessment):
    ...
    if assessment['assessment']['priority_actions']:
        st.markdown("<h4>⚡ Priority Actions</h4>", unsafe_allow_html=True)
    ...
    if assessment['assessment']['recommendations']:
        st.markdown("<h4>💡 Strategic Recommendations</h4>", unsafe_allow_html=True)
...
def show_settings():
    ...
    with sys_col1:
        st.markdown("<h4>Application Status</h4>", unsafe_allow_html=True)
        ...
        st.markdown("<h4>Prediction History</h4>", unsafe_allow_html=True)
...
def show_incident_simulation():
    ...
    if st.button("🚀 Run Simulation", type="primary", use_container_width=True):
        with st.spinner("Running AI-powered incident simulation..."):
            ...
            st.markdown("<h5>🎯 AI Recommendations</h5>", unsafe_allow_html=True)
